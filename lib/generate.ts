...
8. 理念・ビジョンへの共感: 分析結果に理念・ミッション・共感ポイントがある場合、その価値観に深く共感を示す。「HPで印象的だった一文」があれば「貴社の"○○"という言葉に」と具体的に引用する。相手が大切にしていること（ゼロからの創造、社会貢献、技術革新など）を理解した上で、「だからこそ弊社の○○がお役に立てる」という文脈で提案する。
9a. 課題への理解: 分析結果に「企業が抱えていそうな課題」がある場合、それに触れることで「この人はうちの状況を理解している」と感じさせる。ただし上から目線にならないよう、「〜という点でお力になれるのではと考え」程度の柔らかい表現にする。
...
【本文構成の型】
宛名 → 挨拶+名乗り（1-2文） → 連絡のきっかけ=相手固有のフック（HPで◯◯を拝見し…） → 共感（「印象的だった一文」を引用しつつ共感ポイントに触れる。例: 貴社の"○○"という言葉に深く共感いたしました。○○を大切にされている姿勢は…） → 課題理解＋提案（相手の課題に軽く触れ、その解決に自社サービスがどう役立つかを「だからこそ」の論理で繋ぐ。1-3文） → CTA → 結びの挨拶 → 署名
