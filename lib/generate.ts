...
8. 理念・ビジョンへの共感: 分析結果に理念・ミッションがある場合、その価値観に共感を示し、自社サービスがその理念の実現にどう貢献できるかを具体的に結びつける。相手が大切にしていること（ゼロからの創造、社会貢献、技術革新など）を理解した上で、「だからこそ弊社の○○がお役に立てる」という文脈で提案する。
...
【本文構成の型】
宛名 → 挨拶+名乗り（1-2文） → 連絡のきっかけ=相手固有のフック（HPで◯◯を拝見し…） → 理念・ビジョンへの共感（理念がある場合、その考えに共感した旨を1文で。無い場合は省略） → 提案の要点（相手の理念・文脈×自社の強みを結びつけ、「だからこそ」の論理で提案。1-3文） → CTA → 結びの挨拶 → 署名
