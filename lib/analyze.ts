...
出力は必ず以下のJSON形式のみで返してください。それ以外のテキストは含めないでください:
{
  ...
  "philosophy": "会社理念・ミッション・ビジョン（HPに記載があれば。無ければnull）",
  "atmosphere": "社風・雰囲気（HPの写真やテキストから読み取れる場合。無ければnull）",
  "approach_strategy": "この企業に対する提案アプローチ戦略（自社サービスとの接点を踏まえ、どう切り出すのが効果的か。2-3文）",
  "compatibility": {
